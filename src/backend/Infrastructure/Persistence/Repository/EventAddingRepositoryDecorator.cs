    ...
    where T : class, IAggregateRoot
{
    ...
    {
        return decorated.AddRangeAsync(entities, cancellationToken);
    }
    ...
    {
        return decorated.UpdateRangeAsync(entities, cancellationToken);
    }
    ...
    public Task<int> DeleteRangeAsync(ISpecification<T> specification, CancellationToken cancellationToken = new())
    {
    ...
    {
        return decorated.FirstOrDefaultAsync(specification, cancellationToken);
    }
    ...
    public Task<T?> SingleOrDefaultAsync(
        ...
        CancellationToken cancellationToken = new())
    {
        return decorated.SingleOrDefaultAsync(specification, cancellationToken);
    }
    ...
    {
        return decorated.ListAsync(cancellationToken);
    }

    public Task<List<T>> ListAsync(ISpecification<T> specification, CancellationToken cancellationToken = default)
    {
        return decorated.ListAsync(specification, cancellationToken);
    }
    ...
    {
        return decorated.AnyAsync(specification, cancellationToken);
    }

    public Task<bool> AnyAsync(CancellationToken cancellationToken = default)
    {
        return decorated.AnyAsync(cancellationToken);
    }

    public IAsyncEnumerable<T> AsAsyncEnumerable(ISpecification<T> specification)
    {
        return decorated.AsAsyncEnumerable(specification);
    }

    public Task<int> CountAsync(ISpecification<T> specification, CancellationToken cancellationToken = default)
    {
        return decorated.CountAsync(specification, cancellationToken);
    }
