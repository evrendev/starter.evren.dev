...
namespace Migrators.PostgreSQL.Migrations.Application
{
    ...
    [Migration("20260821175113_AddSoftDeleteToProgressEntities")]
    partial class AddSoftDeleteToProgressEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EvrenDev.Domain.Catalog.CourseEnrollment", b =>
                {
                    ...
                    b.ToTable("CourseEnrollments", "Catalog");
                });

            modelBuilder.Entity("EvrenDev.Domain.Catalog.ImportJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("ProcessedSlides")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("SucceededSlides")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EvrenDev.Domain.Catalog.Option", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EvrenDev.Domain.Catalog.Question", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EvrenDev.Domain.Payments.PaymentOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EvrenDev.Domain.Catalog.Option", b =>
                {
                    b.HasOne("EvrenDev.Domain.Catalog.Question", "Question")
                        .WithMany("Options")
