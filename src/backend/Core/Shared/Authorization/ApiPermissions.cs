...
public static class ApiPermissions
{
    private static readonly ApiPermission[] AllClaims =
    {
        ...
        // Page permissions
        new("View Pages", ApiAction.View, ApiResource.Pages, IsBasic: true),
        new("Search Pages", ApiAction.Search, ApiResource.Pages, IsBasic: true),
        new("Create Pages", ApiAction.Create, ApiResource.Pages),
        new("Update Pages", ApiAction.Update, ApiResource.Pages),
        new("Delete Pages", ApiAction.Delete, ApiResource.Pages),
        new("Generate Pages", ApiAction.Generate, ApiResource.Pages),
        new("Export Pages", ApiAction.Export, ApiResource.Pages),
        new("Clean Pages", ApiAction.Clean, ApiResource.Pages),
        new("Import Pages", ApiAction.Import, ApiResource.Pages),
        // Note permissions
