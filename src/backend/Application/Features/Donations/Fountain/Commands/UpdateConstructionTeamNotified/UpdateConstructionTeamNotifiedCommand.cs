...
namespace EvrenDev.Application.Features.Donations.Fountain.Commands.UpdateConstructionTeamNotified;

public class UpdateConstructionTeamNotifiedCommand : IRequest<Result<BasicFountainDonationDto>>
{
    public Guid Id { get; set; }
}

public class UpdateConstructionTeamNotifiedCommandValidator : AbstractValidator<UpdateConstructionTeamNotifiedCommand>
{
    private readonly IStringLocalizer<UpdateConstructionTeamNotifiedCommandValidator> _localizer;

    public UpdateConstructionTeamNotifiedCommandValidator(IStringLocalizer<UpdateConstructionTeamNotifiedCommandValidator> localizer)
    {
...
public class UpdateConstructionTeamNotifiedCommandHandler : IRequestHandler<UpdateConstructionTeamNotifiedCommand, Result<BasicFountainDonationDto>>
{
    private readonly IDonationDbContext _context;
    private readonly IStringLocalizer<UpdateConstructionTeamNotifiedCommandHandler> _localizer;

    public UpdateConstructionTeamNotifiedCommandHandler(
        IDonationDbContext context,
        IStringLocalizer<UpdateConstructionTeamNotifiedCommandHandler> localizer)
    {
        _context = context;
        _localizer = localizer;
    }

    public async Task<Result<BasicFountainDonationDto>> Handle(UpdateConstructionTeamNotifiedCommand request, CancellationToken cancellationToken)
    {
        ...
        entity.IsConstructionTeamNotified = true;
